require './application'
CrampTest::Application.initialize!

# Development middlewares
if CrampTest::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => CrampTest::Application.root(:public)
end
...
#
run CrampTest::Application.routes
